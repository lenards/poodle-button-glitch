...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.aQ, true);
		} catch (e) {
...
var author$project$Main$Miniature = 1;
var author$project$Main$RecievePoodle = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Main$apiUrl = function (breed) {
	return _List_fromArray(
		['https://dog.ceo/api/breed/', breed, '/images/random']);
};
var author$project$Main$fromPoodle = function (poodle) {
	switch (poodle) {
		case 0:
			return 'poodle/standard';
		case 1:
			return 'poodle/miniature';
		default:
			return 'poodle/toy';
	}
};
...
var author$project$Main$createApiUrl = function (poodle) {
	return A2(
		elm$core$String$join,
		'',
		author$project$Main$apiUrl(
			author$project$Main$fromPoodle(poodle)));
};
...
var author$project$Main$poodleDecoder = A2(elm$json$Json$Decode$field, 'message', elm$json$Json$Decode$string);
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, aw: r.aw, az: r.az, e: r.e, h: r.h, i: r.i, j: r.j, aQ: r.aQ}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{aw: elm$http$Http$emptyBody, az: r.az, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, aQ: r.aQ});
};
var author$project$Main$fetchPoodle = function (poodleType) {
	return elm$http$Http$get(
		{
			az: A2(elm$http$Http$expectJson, author$project$Main$RecievePoodle, author$project$Main$poodleDecoder),
			aQ: author$project$Main$createApiUrl(poodleType)
		});
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{_: elm$core$Maybe$Nothing, K: elm$core$Maybe$Nothing, L: 1},
		author$project$Main$fetchPoodle(1));
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			return _Utils_Tuple2(
				model,
				author$project$Main$fetchPoodle(model.L));
		} else {
			if (!msg.a.$) {
				var imageSrc = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							K: elm$core$Maybe$Just(imageSrc)
						}),
...
var author$project$Main$FetchPoodle = {$: 0};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('Poodle Button!')
								]))
						])),
					A2(
					elm$html$Html$main_,
								...
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													A2(elm$core$Maybe$withDefault, '', model.K)),
													elm$html$Html$Attributes$alt(
													author$project$Main$fromPoodle(model.L))
												]),
											_List_Nil)
										])),
									A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Events$onClick(author$project$Main$FetchPoodle)
												]),
											_List_fromArray(
												[
													elm$html$Html$text('Gimme a Poodle!')
												]))
										]))
								]))
						])),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$style, 'color', 'rebeccapurple')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Acknowledgments!')
								])),
							A2(
							elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('Poodles provided by '),
									A2(
									elm$html$Html$a,
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('https://dog.ceo/dog-api/')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('dog.ceo API')
										])),
									elm$html$Html$text('.'),
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('http://corgi-button.glitch.me')
										]),
									_List_fromArray(
										[
											elm$html$Html$text('Corgi Button')
										])),
									elm$html$Html$text('.'),
									A2(elm$html$Html$br, _List_Nil, _List_Nil),
									elm$html$Html$text('Code and hosting by '),
									A2(
									elm$html$Html$a,
									_List_fromArray(
										[
											elm$html$Html$Attributes$href('https://glitch.com/edit/#!/poodle-button')
										]),
									_List_fromArray(
										[
									...
									elm$html$Html$text('.'),
									A2(elm$html$Html$br, _List_Nil, _List_Nil),
									elm$html$Html$text('Made in 2019')
								]))
						]))
				]))
		]);
...
var author$project$Main$view = function (model) {
	return {
		aw: author$project$Main$renderView(model),
		aO: 'Poodle Button!'
	};
};
